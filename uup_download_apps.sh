#!/bin/bash
#Generated on 2022-11-15 12:25:06 GMT
...
destDir="UUPs"
tempScript="aria2_script.apps.txt"
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=73275c4f-b96a-4195-89e0-cda78aeb6a52&pack=neutral&edition=app&aria2=2"
if [ $? != 0 ]; then
...
echo ""
echo "Attempting to download files..."
7z a -t7z -m0=lzma2 -mx9 -mmt "APPS.7z" "$destDir"
